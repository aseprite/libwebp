...
static WEBP_INLINE uint32_t Average2(const uint32_t* const a,
  ...
  const uint32x2_t a0 = { *a, 0 }, b0 = { *b, 0 };
  const uint8x8_t a1 = vreinterpret_u8_u32(a0);
  const uint8x8_t b1 = vreinterpret_u8_u32(b0);
...
static WEBP_INLINE uint32_t Average3(const uint32_t* const a,
  ...
  const uint32x2_t a0 = { *a, 0 }, b0 = { *b, 0 }, c0 = { *c, 0 };
  const uint8x8_t a1 = vreinterpret_u8_u32(a0);
  const uint8x8_t b1 = vreinterpret_u8_u32(b0);
  const uint8x8_t c1 = vreinterpret_u8_u32(c0);
...
static WEBP_INLINE uint32_t Average4(const uint32_t* const a,
  ...
  const uint32x2_t a0 = { *a, 0 }, b0 = { *b, 0 };
  const uint32x2_t c0 = { *c, 0 }, d0 = { *d, 0 };
  const uint8x8_t a1 = vreinterpret_u8_u32(a0);
  const uint8x8_t b1 = vreinterpret_u8_u32(b0);
  const uint8x8_t c1 = vreinterpret_u8_u32(c0);
  const uint8x8_t d1 = vreinterpret_u8_u32(d0);
...
static WEBP_INLINE uint32_t Select(const uint32_t* const c0,
  ...
  const uint32x2_t C0 = { *c0, 0 }, C1 = { *c1, 0 }, C2 = { *c2, 0 };
  const uint8x8_t p0 = vreinterpret_u8_u32(C0);
  const uint8x8_t p1 = vreinterpret_u8_u32(C1);
  const uint8x8_t p2 = vreinterpret_u8_u32(C2);
