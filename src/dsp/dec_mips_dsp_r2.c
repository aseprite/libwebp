...
static WEBP_INLINE void TrueMotion##SIZE(uint8_t* (DST)) {                     \
...
static void TM4(uint8_t* dst)   { TrueMotion4(dst); }
static void TM8uv(uint8_t* dst) { TrueMotion8(dst); }
static void TM16(uint8_t* dst)  { TrueMotion16(dst); }
