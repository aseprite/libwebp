...
static int Disto4x4(const uint8_t* const a, const uint8_t* const b,
  ...
  d4_in.val[0] = vreinterpret_u8_u32(d_in_ab_0123);
  d4_in.val[1] = vreinterpret_u8_u32(d_in_ab_4567);
  d4_in.val[2] = vreinterpret_u8_u32(d_in_ab_89ab);
  d4_in.val[3] = vreinterpret_u8_u32(d_in_ab_cdef);
