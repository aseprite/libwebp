...
static void ITransformWHT(const int16_t* in, int16_t* out) {
  int kStep = 32; // The store is only incrementing the pointer as if we had
                  // stored a single byte.
  __asm__ volatile (
    // part 1
    ...
    "mov             r10, %[out]                 \n"
    "vst1.16         d0[0], [r10], %[kStep]      \n"
    "vst1.16         d1[0], [r10], %[kStep]      \n"
    "vst1.16         d2[0], [r10], %[kStep]      \n"
    "vst1.16         d3[0], [r10], %[kStep]      \n"
    "vst1.16         d0[1], [r10], %[kStep]      \n"
    "vst1.16         d1[1], [r10], %[kStep]      \n"
    "vst1.16         d2[1], [r10], %[kStep]      \n"
    "vst1.16         d3[1], [r10], %[kStep]      \n"
    "vst1.16         d0[2], [r10], %[kStep]      \n"
    "vst1.16         d1[2], [r10], %[kStep]      \n"
    "vst1.16         d2[2], [r10], %[kStep]      \n"
    "vst1.16         d3[2], [r10], %[kStep]      \n"
    "vst1.16         d0[3], [r10], %[kStep]      \n"
    "vst1.16         d1[3], [r10], %[kStep]      \n"
    "vst1.16         d2[3], [r10], %[kStep]      \n"
    "vst1.16         d3[3], [r10], %[kStep]      \n"
