...
static WEBP_INLINE int DoQuantizeBlock(int16_t in[16], int16_t out[16],
  ...
  __m256i in_reg = _mm256_loadu_si256((__m256i*)&in[0]);
  const __m256i iq_reg = _mm256_loadu_si256((__m256i*)&mtx->iq_[0]);
  const __m256i q_reg = _mm256_loadu_si256((__m256i*)&mtx->q_[0]);
