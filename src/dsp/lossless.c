...
#define COLOR_INDEX_INVERSE(FUNC_NAME, F_NAME, STATIC, TYPE, GET_INDEX,        \
                            GET_VALUE)                                         \
static WEBP_INLINE void F_NAME(const TYPE* src,                                \
...
STATIC void FUNC_NAME(const VP8LTransform* const transform,                    \
  ...
  if (bits_per_pixel < 8) {                                                    \
    ...
    VP8LMapColor_##TYPE(src, color_map, dst, y_start, y_end, width);           \
  }                                                                            \
}

COLOR_INDEX_INVERSE(ColorIndexInverseTransform, MapARGB, static, uint32_t,
                    GetARGBIndex, GetARGBValue)
COLOR_INDEX_INVERSE(VP8LColorIndexInverseTransformAlpha, MapAlpha, , uint8_t,
                    GetAlphaIndex, GetAlphaValue)
...
VP8LMapARGBFunc VP8LMapColor_uint32_t;
VP8LMapAlphaFunc VP8LMapColor_uint8_t;
...
void VP8LDspInit(void) {
  ...
  VP8LMapColor_uint32_t = MapARGB;
  VP8LMapColor_uint8_t = MapAlpha;
