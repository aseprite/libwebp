...
static WEBP_INLINE void Load8x4(const uint8_t* const b, int stride,
  ...
  const __m128i A0 = _mm_set_epi32(
      mem_to_uint32(&b[6 * stride]), mem_to_uint32(&b[2 * stride]),
      mem_to_uint32(&b[4 * stride]), mem_to_uint32(&b[0 * stride]));
  const __m128i A1 = _mm_set_epi32(
      mem_to_uint32(&b[7 * stride]), mem_to_uint32(&b[3 * stride]),
      mem_to_uint32(&b[5 * stride]), mem_to_uint32(&b[1 * stride]));
