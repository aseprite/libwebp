...
static void VFilter16(uint8_t* p, int stride,
  ...
  const uint8x16_t p3 = vld1q_u8(p - 4 * stride);
  const uint8x16_t p2 = vld1q_u8(p - 3 * stride);
  const uint8x16_t p1 = vld1q_u8(p - 2 * stride);
  const uint8x16_t p0 = vld1q_u8(p - 1 * stride);
  const uint8x16_t q0 = vld1q_u8(p + 0 * stride);
  const uint8x16_t q1 = vld1q_u8(p + 1 * stride);
  const uint8x16_t q2 = vld1q_u8(p + 2 * stride);
  const uint8x16_t q3 = vld1q_u8(p + 3 * stride);
  ...
  vst1q_u8(p - 3 * stride, op2);
  vst1q_u8(p - 2 * stride, op1);
  vst1q_u8(p - 1 * stride, op0);
  vst1q_u8(p + 0 * stride, oq0);
  vst1q_u8(p + 1 * stride, oq1);
  vst1q_u8(p + 2 * stride, oq2);
}
