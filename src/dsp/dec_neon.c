...
static WEBP_INLINE void Load4x16(const uint8_t* src, int stride,
  ...
  src -= 2;
  LOAD_LANE_32b(in.val[0], 0);
  LOAD_LANE_32b(in.val[1], 0);
  LOAD_LANE_32b(in.val[2], 0);
  LOAD_LANE_32b(in.val[3], 0);
  LOAD_LANE_32b(in.val[0], 1);
  LOAD_LANE_32b(in.val[1], 1);
  LOAD_LANE_32b(in.val[2], 1);
  LOAD_LANE_32b(in.val[3], 1);
  LOAD_LANE_32b(in.val[0], 2);
  LOAD_LANE_32b(in.val[1], 2);
  LOAD_LANE_32b(in.val[2], 2);
  LOAD_LANE_32b(in.val[3], 2);
  LOAD_LANE_32b(in.val[0], 3);
  LOAD_LANE_32b(in.val[1], 3);
  LOAD_LANE_32b(in.val[2], 3);
  LOAD_LANE_32b(in.val[3], 3);
