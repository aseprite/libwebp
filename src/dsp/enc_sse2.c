...
static WEBP_INLINE int DoQuantizeBlock(int16_t in[16], int16_t out[16],
  ...
  // out = (coeff * iQ + B) >> (QFIX + QFIX2)
  {
    ...
    // out = QUANTDIV(coeff, iQ, B, QFIX + QFIX2)
    out_00 = _mm_srai_epi32(out_00, QFIX + QFIX2);
    out_04 = _mm_srai_epi32(out_04, QFIX + QFIX2);
    out_08 = _mm_srai_epi32(out_08, QFIX + QFIX2);
    out_12 = _mm_srai_epi32(out_12, QFIX + QFIX2);
