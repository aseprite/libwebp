...
static void ITransform(const uint8_t* ref, const int16_t* in, uint8_t* dst,
  ...
  // Add inverse transform to 'ref' and store.
  {
    ...
    if (do_two) {
      ...
      ref0 = _mm_cvtsi32_si128(mem_to_uint32(&ref[0 * BPS]));
      ref1 = _mm_cvtsi32_si128(mem_to_uint32(&ref[1 * BPS]));
      ref2 = _mm_cvtsi32_si128(mem_to_uint32(&ref[2 * BPS]));
      ref3 = _mm_cvtsi32_si128(mem_to_uint32(&ref[3 * BPS]));
    }
    // Convert to 16b.
