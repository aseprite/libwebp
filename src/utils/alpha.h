...
// 'filter' [0, 5] corresponds to prediction methods none, horizontal, vertical,
// gradient & paeth filter. The prediction method 5 will try all the prediction
// methods (0 to 4) and pick the prediction method that gives best compression.
