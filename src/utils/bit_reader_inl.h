...
// Define the following to keep value_ right-justified (saves some shift
// during renormalization). This is usually faster (esp. on ARM).
...
extern void VP8LoadFinalBytes(VP8BitReader* const br);
