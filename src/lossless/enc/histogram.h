...
static inline void HistogramClear(Histogram* const p) {
...
static inline void HistogramInit(Histogram* const p, int palette_code_bits) {
...
static inline void HistogramAdd(Histogram* const p, const Histogram* const a) {
  int i;
...
static inline void HistogramRemove(Histogram* const p,
...
static inline int HistogramNumPixOrCopyCodes(const Histogram* const p) {
