#ifndef THIRD_PARTY_LIBWEBP_V0_2_SRC_ENC_DELTA_PALETTIZATION_H_
#define THIRD_PARTY_LIBWEBP_V0_2_SRC_ENC_DELTA_PALETTIZATION_H_
...
#endif  // THIRD_PARTY_LIBWEBP_V0_2_SRC_ENC_DELTA_PALETTIZATION_H_
