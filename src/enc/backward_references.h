...
// maximum number of references blocks the image will be segmented into
...
struct VP8LBackwardRefs {
  ...
  PixOrCopyBlock** trail_;       // for list recycling
...
void VP8LRefsCursorNextBlock(VP8LRefsCursor* const c);  // internal only
