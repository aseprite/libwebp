...
typedef struct {
  ...
  float PSNR[5];          // peak-signal-to-noise ratio for Y/U/V/All/A
  ...
  // lossless encoder features
  uint32_t lossless_features;  // bit0:cross_color  bit1:subtract green
                               // bit2:prediction   bit3:palette
