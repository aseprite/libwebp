...
// Initializes the contents of 'webp_data' object with default values.
...
// Note: as WebP only supports only even offsets, any odd offsets would be
// snapped to even location using: offset &= ~1
// Parameters:
