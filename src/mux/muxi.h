...
// canvas size is valid. This method can be used for validation-only purposes by
// passing 'width' and 'height' to be NULL.
WebPMuxError MuxValidateAndGetCanvasSize(const WebPMux* const mux,
